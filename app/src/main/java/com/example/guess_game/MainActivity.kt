...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var scorVeiw: TextView
    private lateinit var HighscorView: TextView

    private val answer = "Hi"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scorVeiw=findViewById(R.id.textView)
        ...
        rvMessages.adapter = recylerViewAdapter(this, messages)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        HighscorView = findViewById(R.id.textView2)

        var Highscor=0
            super.onSaveInstanceState(outState)
            outState.putInt("HighScore", Highscor)
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        scor= savedInstanceState.getInt("myNumber", 0)
    }
    ...
    private fun showAlertDialog(title: String) {
        ...
        dialogBuilder.setMessage(title)
            ...
            .setPositiveButton("Yes", DialogInterface.OnClickListener {
                    dialog, id -> scorVeiw.text = "Socre: $scor"
            })
